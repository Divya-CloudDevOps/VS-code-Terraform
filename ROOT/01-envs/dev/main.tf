...
module "vpc" {
source   = "../../02-modules/infrastructure"
...
# ─────────────────────────────
module "frontend-ec2" {
source = "../../02-modules/frontend/ec2"
aws_region = "us-east-1"
...
# ─────────────────────────────
module "frontend_alb" {
source = "../../02-modules/frontend/loadbalancer-frontend"
aws_region = "us-east-1"
vpc_id = module.vpc.vpc_id
...
# ─────────────────────────────
module "backend_alb" {
source = "../../02-modules/backend/loadbalancer-backend"
aws_region = "us-east-1"
vpc_id = module.vpc.vpc_id
subnets = module.vpc.public_subnets
...
source        = "../../02-modules/frontend/launch-template"
...
source        = "../../02-modules/backend/launch-template"
...
module "asg-frontend" {
source     = "../../02-modules/frontend/asg"
